...
function ProfileCard(props : Author) {
  ...
  return (
        ...
        <a href='/CoverGeneratorPage' className={styles.books}><LibraryBooksIcon/>
        </a>
        ...
        >
          ...
          <DialogContent>
            ...
            <DialogActions>
              ...
              style={{ textTransform: 'none', marginLeft: "120px" }} // Adjusted margin
            >
              إضافة صورة
            </Button>
  ...
  InputLabelProps={{
    style: { fontWeight: '900', color: 'black' }
        ...
        />
          ...
          <DialogActions>
            <Button className={styles.button1} size="small" variant="contained" style={{ textTransform: 'none' }} onClick={handleSaveChanges}>
              حفظ
            </Button>
          </DialogActions>
        </Dialog>
      ...
      <Link href="/BookUploadPage"> <Button size="small"  variant="contained"  className={styles.button1} endIcon={<BookIcon/>}>تحميل الكتاب</Button></Link>
       
        <Button id="open-button" size="small" variant="outlined" className={styles.button2} onClick={handleOpenProfileSection}>إضافة قسم الملف الشخصي</Button>
        <Button size="small" variant="outlined" className={styles.button3} onClick={handleOpenEditProfileDialog} endIcon={<EditIcon/>}>تعديل الملف الشخصي</Button>
